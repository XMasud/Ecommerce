...
<!--        <link rel="icon" href="favicon.PNG" type="image/x-icon"/>-->
    ...
    <body bgcolor="#055f93">
        ...
        <form method="post" action="insert_product.php" enctype="multipart/form-data">
            <table style="color:white;" align="center" width="700" border="2" bgcolor="#80519e">
                <tr align="center">
                ...
                <tr>
                    ...
                    <td><textarea name="product_desc" cols="60" rows="8"></textarea></td>
                </tr>
                <tr>
                ...
                <tr align="center">
                    ...
                    <td colspan="7"><a href="/ECOM">Back</a></td>
                </tr>
            </table>
        </form>
